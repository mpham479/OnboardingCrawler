...
<body>
<span class="h1copy">Form List</span>
...
<div class="tableBlock">
    <table class="data" id="data">
        <thead>
        <tr>
            <th class="colHeader noSelect clickableHeader imgHover" onclick="sortTable(0)" sortdir="" data="Name">Name
                <img src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'></th>
            <th class="colHeader noSelect clickableHeader imgHover" onclick="sortTable(1)" sortdir="" data="System Id">
                System Id <img src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'>
            </th>
        ...
        <tbody>
        <#foreach form in forms?values>
            <tr class='${["odd", "even"][form_index%2]}' systemid='${form.systemid}'>
                <td class="default">
                    <#if fileBasedLinks>
                        <a href="file:forms/${form.systemid}.${baseExt}">${(form.name)!" "}</a>
                    <#else>
                        <a href="${articleBaseUrl + form.systemid?replace('_',replaceSpacesInUrlsWith,'r')}">${(form.name)!" "}</a>
                    </#if>
                </td>
                <td class="default">${(form.systemid) !" "}</td>
                <td class="default" style="white-space:normal;">${(form.description)!" "}</td>
                <td class="moreInfo">
                    <#if fileBasedLinks>
                        <a class="imgHover"><img src="images/more_info.png" class="infoImg imgOn"
                                                 onclick="openModalInfo(this)"/><img src="images/more_info_hover.png"
                                                                                     class="infoImg imgOff"
                                                                                     onclick="openModalInfo(this)"/></a>
                    <#else>
                        <a class="imgHover"><img src="${imgBaseUrl}more_info.png" class="infoImg imgOn"
                                                 onclick="openModalInfo(this)"/><img
                                    src="${imgBaseUrl}more_info_hover.png" class="infoImg imgOff"
                                    onclick="openModalInfo(this)"/></a>
                    </#if>
                </td>
            </tr>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="height:80%!important">
        ...
        <div class="modal-content">
            ...
            <div width="100%" align="right">
                <#if fileBasedLinks>
                    <span class="imgHover"><img src="images/close.png" class="closeicon imgOn"
                                                onclick="closeModal()"/><img src="images/close_hover.png"
                                                                             class="closeicon imgOff"
                                                                             onclick="closeModal()"/></span>
                <#else>
                    <span class="imgHover"><img src="${imgBaseUrl}close.png" class="closeicon imgOn"
                                                onclick="closeModal()"/><img src="${imgBaseUrl}close_hover.png"
                                                                             class="closeicon imgOff"
                                                                             onclick="closeModal()"/></span>
                </#if>
            </div>
    ...
    <script>
        ...
        function openModalInfo(ele) {
            var frameUrl = '';
            <#if fileBasedLinks>
            frameUrl = "file:forms/" + ele.parentElement.parentElement.parentElement.getAttribute("systemid") + ".${baseExt}"
