...
<div id="scriptData">
        ...
        <div class="tableBlock">
            ...
            <table class="data">
                ...
                <th class="colHeader clickableHeader noSelect imgHover"
                    onclick="sortTable(0,this.parentElement.parentElement.parentElement)" sortdir="">Name <img src=""
                                                                                                               class="imgOn"
                                                                                                               style='width:14px'><img
                            src="" class="imgOff" style='width:14px'></th>
                <th class="colHeader clickableHeader noSelect imgHover"
                    onclick="sortTable(1,this.parentElement.parentElement.parentElement)" sortdir="">System Id <img
                            src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'></th>
                </thead>
                <tbody>
    ...
    <#if actionUsages?has_content>
        <div class="tableBlock">
            ...
            <table class="data" id="data">
                ...
                <tr>
                    <th class="colHeader clickableHeader noSelect imgHover"
                        onclick="sortTable(0,this.parentElement.parentElement.parentElement)" sortdir="">Workflow <img
                                src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'>
                    </th>
                    <th class="colHeader clickableHeader noSelect imgHover"
                        onclick="sortTable(1,this.parentElement.parentElement.parentElement)" sortdir="">Action Name
                        <img src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'></th>
                    <th class="colHeader clickableHeader noSelect imgHover"
                        onclick="sortTable(2,this.parentElement.parentElement.parentElement)" sortdir="">Start Status
                        <img src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'></th>
                    <th class="colHeader clickableHeader noSelect imgHover"
                        onclick="sortTable(3,this.parentElement.parentElement.parentElement)" sortdir="">End Status <img
                                src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'>
                    </th>
                    <th class="colHeader clickableHeader noSelect imgHover"
                        onclick="sortTable(4,this.parentElement.parentElement.parentElement)" sortdir="">Description
                        <img src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'></th>
                </tr>
                </thead>
                <tbody>
    ...
    <#if formImage??>
        <div class="tableBlock">
			<span class="h2Copy collapsible" onclick="toggleCollapse(this);">
			<span style="padding-left: 5px;">Form Image</span>
			<span id="expandSymbol">+</span>
			</span>

            <div class="content" style="text-align: center">
                <#if fileBasedLinks>
                    <img src="images/${systemid}.png"/>
                <#else>
                    <img src="${articleBaseUrl + systemid}.png"/>
                </#if>
            </div>
        </div>
    </#if>
