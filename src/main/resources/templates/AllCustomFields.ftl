<html>
	...
	<body>
	  <span class="h1copy">Custom Field List</span>
		  ...
		  <table class="data" id="data">
		  	<thead>
				<tr>
					...
					<th class="colHeader noSelect clickableHeader imgHover" onclick="sortTable(2)" sortdir="" data="Field Type">Field Type <img src="" class="imgOn" style='width:14px'><img src="" class="imgOff" style='width:14px'></th>
					<th class="colHeader">Label </th>
					<th class="colHeader"></th>
				</tr>
			</thead>
			<tbody>
			<#foreach customfield in customfields?values>
				<#if customfield.name??>                  
				<tr class='${["odd", "even"][customfield_index%2]}' systemid='${customfield.systemId}'>
					...
					<td class="default">${(customfield.systemId) !" "}</td>
					<td class="default">${(customfield.type) !" "}</td>
					<td class="default" style="white-space:normal;">${(customfield.label)!" "}</td>
					<td class="moreInfo">
						<#if fileBasedLinks>
